...
@section('title', 'Nouveau Budget Régional')
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                <h1 class="text-4xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
                    Nouveau Budget Régional
                </h1>
                <p class="text-gray-600 text-lg mt-2">Créez un nouveau budget régional</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600">Remplissez les informations pour créer un nouveau budget régional</p>
            </div>
        </div>

        <form action="{{ route('financial-data.regional-budgets.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="taxe_adjudication_1_6" id="taxe_adjudication_1_6" value="{{ old('taxe_adjudication_1_6', 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="taxe_reconnaissance_interets" id="taxe_reconnaissance_interets" value="{{ old('taxe_reconnaissance_interets', 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="ta_saisie_caution" id="ta_saisie_caution" value="{{ old('ta_saisie_caution', 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="budget_fmf" id="budget_fmf" value="{{ old('budget_fmf', 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="remboursement_fmf_autres" id="remboursement_fmf_autres" value="{{ old('remboursement_fmf_autres', 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="taxe_fmf_20" id="taxe_fmf_20" value="{{ old('taxe_fmf_20', 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="taxe_mise_en_charge" id="taxe_mise_en_charge" value="{{ old('taxe_mise_en_charge', 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="chasse_peche" id="chasse_peche" value="{{ old('chasse_peche', 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="taxe_12_bois_importes" id="taxe_12_bois_importes" value="{{ old('taxe_12_bois_importes', 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500">
                </div>
            </div>
