...
@section('title', 'Modifier Espèce - DEFATP')
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600 text-lg mt-2">Modifiez les informations de l'espèce</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600">Modifiez les informations de l'espèce</p>
            </div>
        </div>

        <form action="{{ route('contracts.especes.update', $espece) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                <label for="name" class="block text-sm font-semibold text-gray-700 mb-2">
                    Nom de l'Espèce <span class="text-red-500">*</span>
                </label>
                <input 
                    type="text" 
                    name="name" 
                    id="name" 
                    value="{{ old('name', $espece->name) }}"
            ...
            <div class="flex items-center gap-4 pt-6 border-t border-gray-200">
                ...
                <a 
                    href="{{ route('contracts.index', ['tab' => 'especes']) }}" 
