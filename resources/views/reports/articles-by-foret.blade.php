...
@section('title', 'Articles par Forêt')
...
<div class="content-card">
    ...
    <div class="header-content">
        <div>
            <h1 class="card-title">Articles par Forêt</h1>
            <p class="card-subtitle">Analysez les articles par forêt avec des statistiques détaillées</p>
        </div>
