...
@section('title', 'Modifier Partenariat - DEFATP')
...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600 text-lg mt-2">Modifiez les informations du partenariat</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
        <form action="{{ route('partenariats.update', $partenariat) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-6 border border-indigo-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nom_association" id="nom_association" value="{{ old('nom_association', $partenariat->nom_association) }}" 
                    ...
                    <div>
                        ...
                        <input type="number" name="nombre_adherents_association" id="nombre_adherents_association" value="{{ old('nombre_adherents_association', $partenariat->nombre_adherents_association) }}" 
                               min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="date" name="date_creation_association" id="date_creation_association" value="{{ old('date_creation_association', $partenariat->date_creation_association ? $partenariat->date_creation_association->format('Y-m-d') : '') }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <select name="localisation_id" id="localisation_id" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            ...
                            @foreach($localisations as $localisation)
                                <option value="{{ $localisation->id }}" {{ old('localisation_id', $partenariat->localisation_id) == $localisation->id ? 'selected' : '' }}>
            ...
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="superficie" id="superficie" value="{{ old('superficie', $partenariat->superficie) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="text" name="nom_périmètre" id="nom_périmètre" value="{{ old('nom_périmètre', $partenariat->nom_périmètre) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <select name="essence_id" id="essence_id" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            ...
                            @foreach($essences as $essence)
                                <option value="{{ $essence->id }}" {{ old('essence_id', $partenariat->essence_id) == $essence->id ? 'selected' : '' }}>
                                    {{ $essence->essence }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="number" name="Superficie_ha" id="Superficie_ha" value="{{ old('Superficie_ha', $partenariat->Superficie_ha) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <textarea name="object_cmd" id="object_cmd" rows="3"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('object_cmd', $partenariat->object_cmd) }}</textarea>
                    </div>
                    <div>
                        <label for="num_contract" class="block text-sm font-semibold text-gray-700 mb-2">
                            Numéro Contrat
                        </label>
                        <input type="text" name="num_contract" id="num_contract" value="{{ old('num_contract', $partenariat->num_contract) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="date" name="date_signature_contract" id="date_signature_contract" value="{{ old('date_signature_contract', $partenariat->date_signature_contract ? $partenariat->date_signature_contract->format('Y-m-d') : '') }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="num_avenant" id="num_avenant" value="{{ old('num_avenant', $partenariat->num_avenant) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="number" name="nombre_avenant" id="nombre_avenant" value="{{ old('nombre_avenant', $partenariat->nombre_avenant) }}" 
                               min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="date" name="date_signature_avenant" id="date_signature_avenant" value="{{ old('date_signature_avenant', $partenariat->date_signature_avenant ? $partenariat->date_signature_avenant->format('Y-m-d') : '') }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="number" name="Superficie_Contrat_avenant" id="Superficie_Contrat_avenant" value="{{ old('Superficie_Contrat_avenant', $partenariat->Superficie_Contrat_avenant) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl p-6 border border-orange-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" name="Date_PV_etat_des_lieux" id="Date_PV_etat_des_lieux" value="{{ old('Date_PV_etat_des_lieux', $partenariat->Date_PV_etat_des_lieux ? $partenariat->Date_PV_etat_des_lieux->format('Y-m-d') : '') }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="number" name="Taux_de_réussite" id="Taux_de_réussite" value="{{ old('Taux_de_réussite', $partenariat->Taux_de_réussite) }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="Etat_de_la_clôture" id="Etat_de_la_clôture" value="{{ old('Etat_de_la_clôture', $partenariat->Etat_de_la_clôture) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="text" name="Etat_peuplement" id="Etat_peuplement" value="{{ old('Etat_peuplement', $partenariat->Etat_peuplement) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <textarea name="PV_évaluation" id="PV_évaluation" rows="3"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('PV_évaluation', $partenariat->PV_évaluation) }}</textarea>
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <textarea name="observations" id="observations" rows="3"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('observations', $partenariat->observations) }}</textarea>
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <textarea name="Contraintes" id="Contraintes" rows="3"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('Contraintes', $partenariat->Contraintes) }}</textarea>
                    </div>
                </div>
            </div>
