...
<div class="min-w-0 max-w-full overflow-x-hidden">
    ...
    >
        <x-slot name="actions">
            <x-button href="{{ route('users.show', $user) }}" variant="secondary" icon="fas fa-eye">Voir</x-button>
        </x-slot>
    </x-page-header>
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('role') is-invalid @enderror" 
                                        ...
                                        <option value="admin" {{ old('role', $user->role?->value) == 'admin' ? 'selected' : '' }}>Administrateur</option>
                                        <option value="agency" {{ old('role', $user->role?->value) == 'agency' ? 'selected' : '' }}>Agence</option>
                                    </select>
                                    @error('role')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="w-1/2">
                                <h6 class="text-primary mb-3">
                                    <i class="fas fa-shield-alt mr-2"></i>Sécurité et Rôles
                                </h6>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-info">
                        <i class="fas fa-user mr-2"></i>Informations Actuelles
                    </h6>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        @forelse($user->roles as $role)
                            <span class="badge bg-success mr-1 mb-1">{{ $role->name }}</span>
                        @empty
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success">
                        <i class="fas fa-shield-alt mr-2"></i>Rôles Disponibles
                    </h6>
                </div>
                <div class="card-body">
                    @foreach($roles as $role)
