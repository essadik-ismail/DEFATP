...
<div class="tab-pane fade show active" id="essences" role="tabpanel">
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-green-600">Affichage de {{ $essences->firstItem() ?? 0 }} à {{ $essences->lastItem() ?? 0 }} sur {{ $essences->total() }} essences</p>
                </div>
            </div>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div class="flex items-center gap-4">
                <label for="essencesPerPageSelect" class="text-sm font-semibold text-green-700">Essences par page:</label>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            <div class="overflow-x-auto">
                <table id="essencesTable" class="w-full">
