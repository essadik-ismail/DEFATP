    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600">Remplissez les informations pour créer un nouveau résumé national</p>
            </div>
        </div>

        <form action="{{ route('financial-data.national-summaries.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="budget_general_ta" id="budget_general_ta" value="{{ old('budget_general_ta', 0) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500">
                    </div>
                    <div>
