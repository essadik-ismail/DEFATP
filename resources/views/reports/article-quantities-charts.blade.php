...
@section('title', 'Graphiques des Quantités de Produits (Articles)')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-4xl font-bold bg-clip-text text-transparent" style="background: linear-gradient(to right, #059669, #047857); -webkit-background-clip: text; background-clip: text;">Graphiques des Quantités de Produits (Articles)</h1>
                    <p class="text-gray-600 text-lg mt-2">Analysez les quantités de produits par année et par localisation (Articles actuels uniquement)</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mb-8">
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div class="flex items-center gap-2 text-blue-800">
                ...
                <span class="font-medium">Données Actuelles :</span>
                <span>Ces graphiques présentent uniquement les données des articles actuels.</span>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg p-6 border border-white/20">
            ...
            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div class="flex items-center gap-2 text-blue-800">
                    ...
                    <span>Articles actuels uniquement (via relations localisation).</span>
                </div>
            </div>
    ...
    <div class="flex flex-wrap gap-4">
        ...
        <button onclick="exportCharts()" 
                class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors flex items-center gap-2">
...
document.addEventListener('DOMContentLoaded', function () {
        ...
        chart1 = new Chart(ctx1, {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Évolution des Quantités par Année (Articles Actuels)'
                    }
                },
                scales: {
                    y: {
    ...
    window.exportCharts = function() {
        ...
        link1.download = 'chart1-article-quantities-by-year.png';
        link1.href = canvas1.toDataURL();
        link1.click();
        
        setTimeout(() => {
            const link2 = document.createElement('a');
            link2.download = 'chart2-article-quantities-by-localisation.png';
