...
@section('title', 'Modifier Part Annuelle de Province')
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                <h1 class="text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                    Modifier Part Annuelle de Province
                </h1>
                <p class="text-gray-600 text-lg mt-2">Modifiez les informations de la part annuelle</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600">Modifiez les informations de la part annuelle</p>
            </div>
        </div>

        <form action="{{ route('financial-data.province-annual-shares.update', $provinceAnnualShare) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="situation_administrative_id" id="situation_administrative_id" 
                        ...
                        @foreach($situationsAdministratives as $situation)
                            <option value="{{ $situation->id }}" {{ old('situation_administrative_id', $provinceAnnualShare->situation_administrative_id) == $situation->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="number" name="year" id="year" value="{{ old('year', $provinceAnnualShare->year) }}" 
                ...
                <div>
                    ...
                    <input type="number" name="llege" id="llege" value="{{ old('llege', $provinceAnnualShare->llege ?? 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="bols_charbon_tanin" id="bols_charbon_tanin" value="{{ old('bols_charbon_tanin', $provinceAnnualShare->bols_charbon_tanin ?? 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="alfa" id="alfa" value="{{ old('alfa', $provinceAnnualShare->alfa ?? 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="produits_divers" id="produits_divers" value="{{ old('produits_divers', $provinceAnnualShare->produits_divers ?? 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="interets_retard" id="interets_retard" value="{{ old('interets_retard', $provinceAnnualShare->interets_retard ?? 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="total_province" id="total_province" value="{{ old('total_province', $provinceAnnualShare->total_province ?? 0) }}" 
                           step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
            </div>
