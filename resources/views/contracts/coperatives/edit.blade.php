...
@section('title', 'Modifier Coopérative - DEFATP')

@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('contracts.index') }}">Contrats</a></li>
<li class="breadcrumb-item active">Modifier coopérative</li>
@endsection
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                <h1 class="text-4xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
                    Modifier Coopérative
                </h1>
                <p class="text-gray-600 text-lg mt-2">Modifiez les informations de la coopérative</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600">Modifiez les informations de la coopérative</p>
            </div>
        </div>

        <form action="{{ route('contracts.coperatives.update', $coperative) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                >
                    ...
                    @foreach($vocations as $vocation)
                        <option value="{{ $vocation->id }}" {{ old('vocation_id', $coperative->vocation_id) == $vocation->id ? 'selected' : '' }}>
                            {{ $vocation->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    name="nombre_membres" 
                    id="nombre_membres" 
                    value="{{ old('nombre_membres', $coperative->nombre_membres) }}"
                    min="0"
                    class="form-input w-full px-4 py-3 border border-gray-300 rounded-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-gray-400"
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    value="{{ old('nombre_coperatives', $coperative->nombre_coperatives) }}"
                    min="0"
                    class="form-input w-full px-4 py-3 border border-gray-300 rounded-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-gray-400"
