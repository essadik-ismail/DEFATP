...
<div class="tab-pane fade" id="localisations" role="tabpanel">
    ...
    <div class="mb-6">
        <form method="GET" action="{{ route('entity-data.index') }}" class="flex gap-3">
            <input type="hidden" name="tab" value="localisations">
            ...
            @if(request('localisation_search'))
                <a href="{{ route('entity-data.index', ['tab' => 'localisations']) }}" 
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div class="overflow-x-auto">
            <table id="localisationsTable" class="w-full">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center gap-2">
                                <a href="{{ route('settings.localisations.edit', $localisation) }}" 
                                ...
                                <form action="{{ route('settings.localisations.destroy', $localisation) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" 
    ...
    @if($localisations->hasPages())
        <div class="mt-6 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                {{ $localisations->appends(array_merge(request()->query(), ['tab' => 'localisations']))->links() }}
            </div>
        </div>
    @endif
</div>
