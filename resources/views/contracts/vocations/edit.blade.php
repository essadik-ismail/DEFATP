    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600 text-lg mt-2">Modifiez les informations de la vocation</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600">Modifiez les informations de la vocation</p>
            </div>
        </div>

        <form action="{{ route('contracts.vocations.update', $vocation) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
