...
@section('title', 'Nouvelle Entrée - Journal d\'Activités')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600 text-lg mt-2">Ajoutez une nouvelle entrée à votre journal d'activités</p>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('activity-journals.store') }}" method="POST" class="space-y-8">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-group md:col-span-2">
                    ...
                    <textarea 
                        ...
                        name="Participants" 
                        rows="3"
                        placeholder="Listez les participants séparés par des virgules">{{ old('Participants') }}</textarea>
                    @error('Participants')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="space-y-6">
                <div class="form-group">
                    ...
                    <textarea 
                        ...
                        name="Description" 
                        rows="5"
                        placeholder="Décrivez l'activité en détail...">{{ old('Description') }}</textarea>
                    @error('Description')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea 
                        ...
                        rows="4"
                        placeholder="Listez les recommandations...">{{ old('Recommandations') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea 
                        ...
                        name="Conclusion" 
                        rows="4"
                        placeholder="Résumez les conclusions...">{{ old('Conclusion') }}</textarea>
                    @error('Conclusion')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
