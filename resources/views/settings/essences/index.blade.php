...
@section('content')
            ...
            <form action="{{ route('settings.essences.store') }}" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-3">
                        ...
                        <input type="text" id="essence" name="essence" required class="form-control" placeholder="Ex: Chêne, Pin, Eucalyptus...">
                    </div>
    ...
    {{-- Enhanced Advanced Filter Section --}}
                    ...
                    <div class="row g-3 align-items-end"> <!-- Changed to Bootstrap-like row with gutters -->
                        ...
                        <div class="col-md-3 col-6">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="search" name="search" value="{{ request('search') }}" class="form-control" placeholder="Rechercher dans les essences...">
                            </div>
                        </div>
        ...
        <!-- Buttons -->
        <div class="col-md-3 col-6 d-flex gap-3 align-items-end">
                            ...
                            <tr class="table-row hover:bg-gray-50">
                                ...
                                <td class="table-cell">
                                    <div class="flex items-center space-x-2">
                                        <i onclick="editEssence({{ $essence->id }})"  class="material-icons text-base" title="Modifier">edit</i>
                                        <i onclick="deleteEssence({{ $essence->id }})" class="material-icons text-base" title="Supprimer">delete</i>
                                    </div>
                                </td>
                            </tr>
                        @empty
