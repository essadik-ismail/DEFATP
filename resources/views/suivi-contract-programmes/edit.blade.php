...
<div class="container mx-auto px-4 py-8">
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                <h1 class="text-4xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                    Modifier Suivi Contract Programme
                </h1>
                <p class="text-gray-600 text-lg mt-2">Modifiez les informations du suivi de contrat programme</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
        <form action="{{ route('suivi-contract-programmes.update', $suiviContractProgramme) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-6 border border-indigo-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="partenariat_id" id="partenariat_id" required
                            ...
                            @foreach($partenariats as $p)
                                <option value="{{ $p->id }}" {{ (old('partenariat_id', $suiviContractProgramme->partenariat_id) == $p->id) ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="foret_id" id="foret_id" 
                            ...
                            @foreach($forets as $foret)
                                <option value="{{ $foret->id }}" {{ old('foret_id', $suiviContractProgramme->foret_id) == $foret->id ? 'selected' : '' }}>
                                    {{ $foret->foret }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="number" name="Année" id="Année" value="{{ old('Année', $suiviContractProgramme->Année) }}" 
                               min="1900" max="2100"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="CT" id="CT" value="{{ old('CT', $suiviContractProgramme->CT) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="text" name="DPF" id="DPF" value="{{ old('DPF', $suiviContractProgramme->DPF) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="text" name="Parcelle" id="Parcelle" value="{{ old('Parcelle', $suiviContractProgramme->Parcelle) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="text" name="Projet_CP" id="Projet_CP" value="{{ old('Projet_CP', $suiviContractProgramme->Projet_CP) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="Superficie_prévue_CP_ha" id="Superficie_prévue_CP_ha" value="{{ old('Superficie_prévue_CP_ha', $suiviContractProgramme->Superficie_prévue_CP_ha) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="number" name="Montant_prévu_CP_dh" id="Montant_prévu_CP_dh" value="{{ old('Montant_prévu_CP_dh', $suiviContractProgramme->Montant_prévu_CP_dh) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="Superficie_engagée_ha" id="Superficie_engagée_ha" value="{{ old('Superficie_engagée_ha', $suiviContractProgramme->Superficie_engagée_ha) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="number" name="Montant_engagé_dh" id="Montant_engagé_dh" value="{{ old('Montant_engagé_dh', $suiviContractProgramme->Montant_engagé_dh) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl p-6 border border-orange-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="Superficie_payée_ha" id="Superficie_payée_ha" value="{{ old('Superficie_payée_ha', $suiviContractProgramme->Superficie_payée_ha) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="number" name="Montant_payé_dh" id="Montant_payé_dh" value="{{ old('Montant_payé_dh', $suiviContractProgramme->Montant_payé_dh) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="number" name="Superficie_non_payée" id="Superficie_non_payée" value="{{ old('Superficie_non_payée', $suiviContractProgramme->Superficie_non_payée) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <textarea name="Motif_du_Non_paiement" id="Motif_du_Non_paiement" rows="3"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('Motif_du_Non_paiement', $suiviContractProgramme->Motif_du_Non_paiement) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center gap-4 pt-6 border-t border-gray-200">
                ...
                <a href="{{ route('partenariats.show', $suiviContractProgramme->partenariat_id) }}" 
