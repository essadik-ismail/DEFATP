...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
        <form action="{{ route('financial-data.update', $nationalSummary) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select name="month" id="month" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            ...
                            @for($i = 1; $i <= 12; $i++)
                                <option value="{{ $i }}" {{ old('month', $nationalSummary->month) == $i ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="situation_administrative_id" id="situation_administrative_id" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            ...
                            @foreach($situationsAdministratives as $situation)
                                <option value="{{ $situation->id }}" {{ old('situation_administrative_id', $nationalSummary->situation_administrative_id) == $situation->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="localisation_id" id="localisation_id" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            ...
                            @foreach($localisations as $localisation)
                                <option value="{{ $localisation->id }}" {{ old('localisation_id', $nationalSummary->localisation_id) == $localisation->id ? 'selected' : '' }}>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="budget_general_taj" id="budget_general_taj" value="{{ old('budget_general_taj', $nationalSummary->budget_general_taj ?? 0) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="part_etat" id="part_etat" value="{{ old('part_etat', $nationalSummary->part_etat ?? 0) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="number" name="cas_fnf_total" id="cas_fnf_total" value="{{ old('cas_fnf_total', $nationalSummary->cas_fnf_total ?? 0) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="number" name="cas_chasse_peche_total" id="cas_chasse_peche_total" value="{{ old('cas_chasse_peche_total', $nationalSummary->cas_chasse_peche_total ?? 0) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-6 border border-indigo-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="provinces_Alfa" id="provinces_Alfa" value="{{ old('provinces_Alfa', $nationalSummary->provinces_Alfa ?? 0) }}" 
                               step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
