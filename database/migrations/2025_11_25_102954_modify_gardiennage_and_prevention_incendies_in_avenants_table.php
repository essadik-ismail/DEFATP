...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('avenants', function (Blueprint $table) {
            // Drop old columns
            $table->dropColumn(['gardiennage', 'prevention_incendies']);
    ...
    public function down(): void
    {
        Schema::table('avenants', function (Blueprint $table) {
            ...
            // Restore old columns
            $table->decimal('gardiennage', 10, 2)->nullable()->after('superficie');
            $table->decimal('prevention_incendies', 10, 2)->nullable()->after('gardiennage');
        });
    }
};
